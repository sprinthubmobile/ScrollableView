#
#  Be sure to run `pod spec lint ScrollableView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://EXAMPLE/ScrollableView"
  ...
  spec.source       = { :git => "https://github.com/sprinthubmobile/ScrollableView.git", :tag => "#{spec.version}" }
